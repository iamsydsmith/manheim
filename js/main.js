$(document).ready(function() {
    ...
    $("#square-0").click(function() {
        ...
        $("#dialog-0 .submit").click(function() {
            ...
            $("#square-0").hide("drop", { direction: "down" }, "slow");
            $("#dialog-0").remove();
    ...
    $("#square-1").click(function() {
        ...
        $("#dialog-1 .submit").click(function() {
            ...
            $("#square-1").hide("drop", { direction: "down" }, "slow");
            $("#dialog-1").remove();
            console.log(resArray.length);
    ...
    $("#square-2").click(function() {
        ...
        $("#dialog-2 .submit").click(function() {
            ...
            $("#square-2").hide("drop", { direction: "down" }, "slow");
            $("#dialog-2").remove();
            console.log(resArray.length);
    ...
    $("#square-3").click(function() {
        ...
        $("#dialog-3 .submit").click(function() {
            ...
            $("#square-3").hide("drop", { direction: "down" }, "slow");
            $("#dialog-3").remove();
            console.log(resArray.length);
    ...
    $("#square-4").click(function() {
        ...
        $("#dialog-4 .submit").click(function() {
            ...
            $("#square-4").hide("drop", { direction: "down" }, "slow");
            $("#dialog-4").remove();
            console.log(resArray.length);
    ...
    $("#square-5").click(function() {
        ...
        $("#dialog-5 .submit").click(function() {
            ...
            $("#square-5").hide("drop", { direction: "down" }, "slow");
            $("#dialog-5").remove();
            console.log(resArray.length);
    ...
    $("#square-6").click(function() {
        ...
        $("#dialog-6 .submit").click(function() {
            ...
            $("#square-6").hide("drop", { direction: "down" }, "slow");
            $("#dialog-6").remove();
            console.log(resArray.length);
    ...
    $("#square-7").click(function() {
        ...
        $("#dialog-7 .submit").click(function() {
            ...
            $("#square-7").hide("drop", { direction: "down" }, "slow");
            $("#dialog-7").remove();
            console.log(resArray.length);
    ...
    $("#square-8").click(function() {
        ...
        $("#dialog-8 .submit").click(function() {
            ...
            $("#square-8").hide("drop", { direction: "down" }, "slow");
            $("#dialog-8").remove();
            console.log(resArray.length);
    ...
    $("#square-9").click(function() {
        ...
        $("#dialog-9 .submit").click(function() {
            ...
            $("#square-9").hide("drop", { direction: "down" }, "slow");
            $("#dialog-9").remove();
            console.log(resArray.length);
    ...
    $("#square-10").click(function() {
        ...
        $("#dialog-10 .submit").click(function() {
            ...
            $("#square-10").hide("drop", { direction: "down" }, "slow");
            $("#dialog-10").remove();
            console.log(resArray.length);
    ...
    $("#square-11").click(function() {
        ...
        $("#dialog-11 .submit").click(function() {
            ...
            $("#square-11").hide("drop", { direction: "down" }, "slow");
            $("#dialog-11").remove();
            console.log(resArray.length);
    ...
    $("#square-12").click(function() {
        ...
        $("#dialog-12 .submit").click(function() {
            ...
            $("#square-12").hide("drop", { direction: "down" }, "slow");
            $("#dialog-12").remove();
            console.log(resArray.length);
    ...
    $("#square-13").click(function() {
        ...
        $("#dialog-13 .submit").click(function() {
            ...
            $("#square-13").hide("drop", { direction: "down" }, "slow");
            $("#dialog-13").remove();
            console.log(resArray.length);
    ...
    $("#square-14").click(function() {
        ...
        $("#dialog-14 .submit").click(function() {
            ...
            $("#square-14").hide("drop", { direction: "down" }, "slow");
            $("#dialog-14").remove();
            console.log(resArray.length);
    ...
    $("#square-15").click(function() {
        ...
        $("#dialog-15 .submit").click(function() {
            ...
            $("#square-15").hide("drop", { direction: "down" }, "slow");
            $("#dialog-15").remove();
            console.log(resArray.length);
    ...
    $("#square-16").click(function() {
        ...
        $("#dialog-16 .submit").click(function() {
            ...
            $("#square-16").hide("drop", { direction: "down" }, "slow");
            $("#dialog-16").remove();
            console.log(resArray.length);
    ...
    $("#square-17").click(function() {
        ...
        $("#dialog-17 .submit").click(function() {
            ...
            $("#square-17").hide("drop", { direction: "down" }, "slow");
            $("#dialog-17").remove();
            console.log(resArray.length);
    ...
    $("#square-18").click(function() {
        ...
        $("#dialog-18 .submit").click(function() {
            ...
            $("#square-18").hide("drop", { direction: "down" }, "slow");
            $("#dialog-18").remove();
            console.log(resArray.length);
    ...
    $("#square-19").click(function() {
        ...
        $("#dialog-19 .submit").click(function() {
            ...
            $("#square-19").hide("drop", { direction: "down" }, "slow");
            $("#dialog-19").remove();
            console.log(resArray.length);
